...
def test_build_legacy_profile_vectors_converts_workbook_units_without_flip() -> None:
    vectors = build_legacy_profile_vectors(_sample_track_profile(), flip=False)
...
def test_build_legacy_profile_vectors_flips_positions_values_and_names() -> None:
    vectors = build_legacy_profile_vectors(_sample_track_profile(), flip=True)
